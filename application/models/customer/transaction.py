...
class Delivery(CommonModel): 
    ...
    # 0: received order, 1: ready for delivery 2: on the road, 3: shipped
    status = db.Column(SmallInteger(), index=True, default=0)  
...
class Order(CommonModel): 
    ...
    delivery_status = db.Column(SmallInteger(), index=True, default=0)  # 0: pending, 1: success, 2: failed
    # WHEN FINISHED ORDER
